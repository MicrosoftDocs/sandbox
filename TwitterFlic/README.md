...
# Configure Flic
1. Copy the function url by navigating to the function in the portal and clicking the "</> Get function URL" link. This url is needed in the Flic app and can be quite long. It is recommended to paste the url in a cloud based document for mobile access.
...
```
https://myFunctionAppName.azurewebsites.net/api/notify/azurefunctions?code=[autogenerated value]
```
