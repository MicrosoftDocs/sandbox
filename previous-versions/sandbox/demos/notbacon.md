...
> [!TIP]
> If you'd like to use the [Computer Vision API](https://docs.microsoft.com/azure/cognitive-services/computer-vision/) to analyze your images and return known tags, check out the [NotHotdog](/previous-versions/sandbox/demos/nothotdog) article.
...
* Check out [NotHotdog](/previous-versions/sandbox/demos/nothotdog) for a variant of this using the Computer Vision API without any training.
